...
return [
    ...
    // 'enabled' => true, // Enable multilingual routes
    // 'default_locale' => 'az', // Set the default locale
    // 'locales' => ['az', 'en'], // Define the available locales (English and Azerbaijani in this case)
    // 'middleware' => ['web'], // Add the middlewares you want to use with multilingual routes
