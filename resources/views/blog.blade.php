...
@section('title')
    {{ __('messages.menu_item4_3') }}
@endsection

@section('meta')
    <meta property="og:title" content="{{ __('messages.menu_item4_3') }}">
    <meta property="og:description" content="@foreach ($blogs as $blog) {{ getLocalizedField($blog, 'head') }}, @endforeach">
    <meta name="description" content="@foreach ($blogs as $blog) {{ getLocalizedField($blog, 'head') }}, @endforeach">
@endsection
